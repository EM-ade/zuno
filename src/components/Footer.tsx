  ...
  return (
    <footer className="w-full py-8 md:py-12">
      <div className="container mx-auto px-4 md:px-6">
        {/* Footer card */}
        <div className="relative bg-white rounded-2xl shadow-md border border-black/5 p-6 md:p-8 overflow-visible">
          {/* Content Row */}
          <div className="flex items-center justify-between gap-6">
            <div className="flex-1 min-w-0 pr-28 md:pr-40">
              ...
              <div className="flex items-center gap-3 sm:gap-4">
                ...
                <a
                  href="#"
                  className="h-14 w-14 sm:h-16 sm:w-16 rounded-xl bg-orange-500 flex items-center justify-center shadow-sm"
                  aria-label="Discord"
                >
                ...
                <a
                  href="#"
                  className="h-14 w-14 sm:h-16 sm:w-16 rounded-xl bg-sky-500 flex items-center justify-center shadow-sm"
                  aria-label="Twitter"
                >
                ...
                {/* Join Button */}
                <button className="h-14 sm:h-16 px-6 sm:px-8 rounded-full bg-[#0186EF] text-white font-semibold shadow-sm">
                  Join the community
                </button>
              </div>
            </div>

            {/* Mascot column - overlap bottom-right */}
            <div className="relative flex-shrink-0">
              ...
              <Image
                ...
                width={240}
                height={240}
                className="w-44 md:w-56 h-auto object-contain absolute -right-3 -bottom-6"
              />
            </div>
          </div>
        </div>

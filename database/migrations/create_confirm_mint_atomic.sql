-- Create the confirm_mint_atomic RPC function
-- This function atomically handles the NFT minting process:
-- 1. Marks items as minted
-- 2. Records mint transactions
-- 3. Updates collection minted count
-- 4. Handles error cases

CREATE OR REPLACE FUNCTION confirm_mint_atomic(
...
EXCEPTION WHEN OTHERS THEN
    ...
    RAISE LOG 'Error in confirm_mint_atomic: %', SQLERRM;
    RETURN json_build_object(
        'success', false,
        'error', SQLERRM,
        'minted_count', 0,
